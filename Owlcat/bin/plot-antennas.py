...
def get_arguments():
    ...
    req.add_argument("--ms", dest="ms_name", required=True, metavar='',
                     help="MS for antennas. This is required",
                     default=None)
    opt.add_argument("-h", "--help", action="help",
                     help="Show this help message and exit")
    opt.add_argument("-c", "--colour", dest="cmap",  metavar='', type=str,
                     ...
                     default=None)
    opt.add_argument("--cofa", dest="cofa", metavar='',
                     type=str,
